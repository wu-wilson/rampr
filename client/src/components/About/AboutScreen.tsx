...
const ROWS: AboutRow[] = [
  ...
  },
  {
    key: 'Cadence',
    value:
      'One poll per day at 06:00 UTC. Each poll writes one open-count snapshot per company. Counts you see are at most 24 hours old.',
  },
  {
    key: 'Trends',
    value:
 ...
 * beside four method rows — what is counted, the daily 06:00 UTC cadence, forward-only
 * trends that unlock at 14 snapshots, and what rampr deliberately is not. The grid spans the
 * full rail with padding inside each cell, so the row hairlines reach the rail's right edge.
