...
- Display/headlines and **every count/number** use **DM Sans** (weights 500–800, `font-display`, `tabular-nums`). Labels, metadata, table cells, and badges use **Courier Prime** (400 + 700 only — `font-semibold`/`font-extrabold` resolve to 700; `font-mono`). Base 14px, line-height 1.5.
